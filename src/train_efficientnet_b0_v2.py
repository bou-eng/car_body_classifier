...
MODEL_PATH = DRIVE_ROOT / "models" / "best_efficientnet_b0_v2.pth"
LAST_MODEL_PATH = DRIVE_ROOT / "models" / "last_efficientnet_b0_v2.pth"

OUTPUT_DIR = DRIVE_ROOT / "outputs" / "efficientnet_b0_v2"
LOG_PATH = DRIVE_ROOT / "logs" / "efficientnet_b0_v2_training_log.csv"
...
def save_curves(history):
    ...
    plt.xlabel("Epoch")
    plt.ylabel("Loss")
    plt.title("Training & Validation Loss - EfficientNet-B0 v2")
    plt.legend()
    plt.grid(True)
    plt.tight_layout()
    ...
    plt.xlabel("Epoch")
    plt.ylabel("Accuracy")
    plt.title("Training & Validation Accuracy - EfficientNet-B0 v2")
    plt.legend()
    plt.grid(True)
    plt.tight_layout()
...
def save_confusion_matrix(y_true, y_pred, classes):
    ...
    plt.title("Normalized Confusion Matrix - EfficientNet-B0 v2")
    plt.colorbar()
...
def main() -> None:
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        if epoch == FROZEN_EPOCHS + 1:
            print("Unfreezing EfficientNet-B0 backbone for fine-tuning...")
