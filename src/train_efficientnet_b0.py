...
LAST_MODEL_PATH = DRIVE_ROOT / "models" / "last_efficientnet_b0.pth"

OUTPUT_DIR = DRIVE_ROOT / "outputs" / "efficientnet_b0"
LOG_PATH = DRIVE_ROOT / "logs" / "efficientnet_b0_training_log.csv"
